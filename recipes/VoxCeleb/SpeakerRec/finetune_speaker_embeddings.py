...
def dataio_prep(hparams):
    ...
    train_data = train_data.filtered_sorted(
            key_min_value={"length": hparams["sentence_len"]} 
        )
    ...
    @sb.utils.data_pipeline.takes("wav", "length")
    @sb.utils.data_pipeline.provides("sig")
    def audio_pipeline(wav, length):
        if hparams["random_chunk"]:
            duration_sample = int(length * hparams["sample_rate"])
